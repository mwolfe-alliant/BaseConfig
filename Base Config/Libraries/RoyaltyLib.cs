    ...
    public static class RoyaltyLib
    {
            ...
            ResultSet priorPeriodItd)        // INPUTSET4
        {
            ...
            for (int N_Counter = 1; N_Counter <= N_RecGroups; N_Counter++)
            {
                ...
                zeroShortfall.SetValue(CustCol.ActualPeriod,    new AlliantEntity(DS.F_CALC_PERIOD().sid));
            ...
            ResultSet windowStartPeriodItd)       // INPUTSET3
        {
            ...
            PeriodItem calcPeriodMinus1 = DS.F_PERIODS_FROM(calcPeriod, -1);
            ...
            if (N_NoneLabel == 0 && forTiering.Rows > 0)
            {
                ...
                // Sort orders for the two TierSets.  DealScript spells out 32 columns;
                // we sort primarily by ActualPeriod, OtherPeriod, value column.  Keys
                // for stable tie-breaking come from the engine's internal sort.
                       ...
                       ResultSet WindowStartPeriodOutput) SubGetImportAdjsPriorITD()
        {
            ...
            dspGetStatusInput.SetValue(CustCol.OtherPeriod, new AlliantEntity(calcPeriod.sid));
            ...
            dspGetResultsInput.SetValue(CustCol.OtherPeriod, new AlliantEntity(calcPeriod.sid));
            ...
            ResultSet priorPeriodItd)        // INPUTSET4
        {
            ...
            var itdRange = DS.F_PERIOD_INTERVAL(inception, calcPeriod);
            ...
            if (N_StmtDeal == 1)
            {
                ...
                currentStmtPeriod.SetValue(CustCol.OtherPeriod, new AlliantEntity(calcPeriod.sid));
                PeriodItem priorStmtPi = !string.IsNullOrEmpty(statementInterval)
                    ? DS.F_PERIOD_TYPES_FROM(calcPeriod, 1, statementInterval)
                    : calcPeriod;
                currentStmtPeriod.SetValue(CustCol.ActualPeriod, new AlliantEntity(priorStmtPi.sid));
